...
We didn't just test our algorithms (though we totally did that too), but we also ran a bunch of simulations to make sure our package is as dependable and precise as we say it is. We’re talking everything from close-up checks of each function to wider simulations that test the whole shebang in different scenarios.
